...
def plot_accuracy(results, model_title,accuracy):
    if accuracy == True:
        ...
        plt.text(20, 75., str("average train: " + str(np.mean(results.train_acc))), family="monospace")
        plt.text(20, 80., str("average test: " + str(np.mean(results.test_acc))), family="monospace")
        # plt.show()
        ...
        # plt.ylim((70,100))
        plt.legend(['train', 'test'], loc='lower right')
        plt.text(20, 20., str("average train: " + str(np.mean(results.train_loss))), family="monospace")
        plt.text(20, 20., str("average test: " + str(np.mean(results.test_loss))), family="monospace")
        # plt.show()
        plt.savefig(str(model_title + ".png"))
        plt.close()
