...
def plot_accuracy(results, model_title,accuracy):
    if accuracy == True:
        ...
        plt.text(20, 20., str("average train: " + str(np.mean(results.train_acc))), family="monospace")
        plt.text(20, 20., str("average test: " + str(np.mean(results.test_acc))), family="monospace")
        # plt.show()
